...
# Initialize components for Routine "RandomiseStim"
RandomiseStimClock = core.Clock()
...
FEAR = ["FEAR1.bmp", "FEAR2.bmp", "FEAR3.bmp", "FEAR4.bmp", "FEAR5.bmp", "FEAR6.bmp", "FEAR7.bmp", "FEAR8.bmp"]
NEUTRAL = ["NEUTRAL1.bmp", "NEUTRAL2.bmp", "NEUTRAL3.bmp", "NEUTRAL4.bmp", "NEUTRAL5.bmp", "NEUTRAL6.bmp", "NEUTRAL7.bmp", "NEUTRAL8.bmp"] 
...
for thisTrial_2 in trials_2:
    ...
    # -------Ending Routine "RandomiseStim"-------
    for thisComponent in RandomiseStimComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    
    # the Routine "RandomiseStim" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    for thisTrial in trials:
        ...
        if LeftD == "FEAR":
            ...
            D_L == NEUTRAL[NeutralLoop]
            NeutralLoop += 1
        elif RightD == "NEUTRAL":
            D_R == NEUTRAL[NeutralLoop]
            NeutralLoop += 1
